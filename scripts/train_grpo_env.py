...
from liar_dice_environment_function import (
    ...
    try:
        ...
        if is_reasoning_tokenizer(tokenizer):
            ...
            if training_args.environment_name == "goof_spiel":
                ...
                rollout_func = liar_dice_rollout_last_prompt_and_completion_parallelized_curriculum
                reward_func = liar_dice_rollout_reward_func
                trainer_class = GRPOTrainer
            ...
            if training_args.environment_name == "goof_spiel":
                ...
                rollout_func = liar_dice_rollout_full_prompt_and_completion_parallelized_curriculum
                reward_func = liar_dice_rollout_reward_func
                trainer_class = ActionMaskedGRPOTrainer
